...
interface CustomerReturnScannerProps {
  onComplete: (_: ReturnUpcEntry[], __: number) => void;
  onChange?: (_: number, __: number) => void;
  onStatePersist?: (_: {
    upcs: ReturnUpcEntry[];
...
const CustomerReturnScanner: React.FC<CustomerReturnScannerProps> = ({
  ...
  const { totalCount, grossCredit: _grossCredit, handlingFee: _handlingFee, glassFee: _glassFee, netCredit } = useMemo(() => {
