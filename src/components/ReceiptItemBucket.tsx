...
interface ReceiptItemBucketProps {
  ...
  onItemToggle?: (
    _item: ClassifiedReceiptItem,
    _classification: ReceiptItemClassification,
    _checked: boolean
  ) => void;
  onItemReclassify?: (_item: ClassifiedReceiptItem, _classification: ReceiptItemClassification) => void;
  onItemScanUpc?: (_item: ClassifiedReceiptItem) => void;
  onItemSearchProduct?: (_item: ClassifiedReceiptItem) => void;
  onItemAttachExisting?: (_item: ClassifiedReceiptItem) => void;
  onItemNeverMatch?: (_item: ClassifiedReceiptItem) => void;
   ...
   */
  getItemKey?: (_item: ClassifiedReceiptItem) => string;
