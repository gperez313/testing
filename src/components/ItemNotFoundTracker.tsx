...
interface ItemNotFoundTrackerProps {
  _orderId: string;
  onItemNotFound: (_item: NotFoundItem) => void;
  notFoundItems: NotFoundItem[];
  onRemoveNotFound: (_sku: string) => void;
  currentStore: string;
  _availableStores: Array<{ id: string; name: string }>;
  onMarkFound?: (_sku: string, _storeName: string) => void;
}
