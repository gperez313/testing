...
interface ManagementViewProps {
  ...
  setSettings: (_: AppSettings) => void;
  approvals: ApprovalRequest[];
  auditLogs: AuditLog[];
  updateOrder: (_: string, __: OrderStatus, ___?: any) => void;
  adjustCredits: (_: string, __: number, ___: string) => void;
  updateUserProfile: (_: string, __: Partial<User>) => void;
  fetchUsers: () => Promise<User[]>;
  fetchUserStats: (_: string) => Promise<UserStatsSummary | null>;
  fetchApprovals: () => Promise<ApprovalRequest[]>;
  fetchAuditLogs: () => Promise<AuditLog[]>;
  fetchReturnVerifications: () => Promise<ReturnVerification[]>;
  settleReturnVerification: (_: string, __: number, ___: number, ____: number) => Promise<void>;
}
    ...
    returns: {
      ...
      render: () => (
        <ManagementReturns
          ...
          returnScanEntries={returnScanEntries}
          setReturnScanEntries={setReturnScanEntries}
        />
      )
    },
    stores: {
